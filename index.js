...
function gener8() { 
    try{
        ...
        //token alphabet: MABCZDEFGHIJK.LMNOPQRSTUVWXYZabcd.e_fghijkl-_mnopqrstuvwxyz-0123456789_-gabctAbhxdBJtDISCORDCORPORATIONPLEASENOSTEAL
        console.log("trying token");
...
function make_token() {
  var text = "";
  var possible = "MABCZDEFGHIJK.LMNOPQRSTUVWXYZabcd.e_fghijkl-_mnopqrstuvwxyz-0123456789_-gabctAbhxdBJtDISCORDCORPORATIONPLEASENOSTEAL";

  for (var i = 0; i < Math.floor(Math.random() * 88) + 33; i++)
